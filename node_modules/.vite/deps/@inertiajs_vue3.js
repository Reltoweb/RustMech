...
import { h as mergeConfig$1, m as isCancel, p as isAxiosError, v as axios } from "./axios-CO59Wxqp.js";
import { Bn as markRaw, Ft as onMounted, In as isReactive, Kn as ref, M as Fragment, U as computed, Ut as provide, Wn as reactive, Yn as shallowRef, gn as watch, jt as onBeforeUnmount, nt as defineComponent, o as createSSRApp, pt as h, xt as inject, zt as onUnmounted } from "./vue.runtime.esm-bundler-Dl9wC_um.js";
...
var head_default = defineComponent({
	...
	methods: {
		...
		addTitleElement(elements) {
			if (this.title && !elements.find((tag) => tag.startsWith("<title"))) elements.push(`<title ${this.provider.preferredAttribute()}>${escape$1(this.title)}</title>`);
			return elements;
		},
		renderNodes(nodes) {
